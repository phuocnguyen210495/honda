<div x-data="{}" class="flex flex-col items-center justify-center mt-6 sm:mt-24" wire:poll.keep-alive="checkForVerification">
    <div class="max-w-lg">
        <x-title :content="__('auth.verify-email.title')" class="text-center" level="h1"/>
        <x-paragraph :content="__('auth.verify-email.details')" class="text-center mt-2"/>
    </div>

    <x-spinner size="12" class="mt-6"/>
